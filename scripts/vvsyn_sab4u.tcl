...
if { $argc == 4 } {
	...
	set psname "*xilinx.com:ip:processing_system7:*"
	set bdrule "xilinx.com:bd_rule:processing_system7"
	...
	} elseif { [ string equal $board "zcu102" ] } { 
...
set ps7 [create_bd_cell -type ip -vlnv [get_ipdefs $psname] ps7]
apply_bd_automation -rule $bdrule -config {make_external "FIXED_IO, DDR" apply_board_preset "1" Master "Disable" Slave "Disable" } $ps7
